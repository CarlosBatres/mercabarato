...
$route['panel_vendedor/visitas/get_estadisticas_afiliados'] = 'admin/panel_vendedores/get_visitas_estadisticas_afiliados';
$route['panel_vendedor/visitas/get_productos_visitas'] = 'admin/panel_vendedores/ajax_get_productos_visitas';
...
$route['panel_vendedor/anuncio/borrar-multi'] = 'admin/panel_vendedores_anuncios/borrar_multi';
...
$route['admin/vendedores/administrar/(:num)'] = 'admin/vendedor/administrar/$1';
$route['admin/vendedores/modificar'] = 'admin/vendedor/modificar';
...
$route['admin/vendedor_paquetes/aprobar/(:num)'] = 'admin/vendedor_paquete/view_aprobar/$1';
$route['admin/vendedor_paquetes/do_aprobar'] = 'admin/vendedor_paquete/aprobar';
