...
class UploadHandler {
    ...
    protected $error_messages = array(
        ...
        'accept_file_types' => 'Este tipo de archivo no esta permitido ( solo acepta JPG,PNG,GIF ).',
    ...
    function __construct($options = null, $initialize = true, $error_messages = null) {
        ...
        $this->options = array(
            ...
            'upload_dir' => dirname($this->get_server_var('SCRIPT_FILENAME')) . '/assets/uploads/imgs/',
            'upload_url' => $this->get_full_url() . '/assets/uploads/imgs/',
            'user_dirs' => false,
            'mkdir_mode' => 0755,
            'param_name' => 'files',
    ...
    protected function trim_file_name($file_path, $name, $size, $type, $error, $index, $content_range) {
        ...
        $name=$this->generate_unique_filename($name);
        return $name;
    }
