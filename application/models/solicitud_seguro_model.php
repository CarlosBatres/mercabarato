...
class Solicitud_seguro_model extends MY_Model {
    ...
    public function cleanup_resources($solicitud_seguro_id) {
        $solicitud_seguro = $this->get($solicitud_seguro_id);
        unlink('./assets/' . $this->config->item('seguros_path') . '/' . $solicitud_seguro->link_file);        
    }

    public function delete($id) {
        $this->cleanup_resources($id);
        $this->mensaje_model->delete_by("solicitud_seguro_id", $id);
        parent::delete($id);
    }
