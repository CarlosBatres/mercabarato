                        ...
                        <td>
                            <div class="options">
                                ...
                                <?php if ($solicitud->estado != "2"): ?>
                                    <a class="row_action cerrar" href="<?php echo site_url('panel_vendedor/infocompras/seguros/cerrar') . '/' . $solicitud->id ?>"  title="Cerrar"><i class="glyphicon glyphicon-ban-circle"></i></a>
                                <?php endif; ?>
                                <a class="row_action borrar" href="<?php echo site_url('panel_vendedor/infocompras/seguros/borrar') . '/' . $solicitud->id ?>"  title="Eliminar"><i class="glyphicon glyphicon-trash"></i></a>
                            </div>                           
                        </td>
                    </tr>
                <?php endforeach; ?>
