<div class="container-fluid">    
    ...
    <div class="row">
        <div class="col-md-5">
            <div class="panel panel-default">
                <div class="panel-heading">
                    <strong>REQUISITOS EN LA OFERTA</strong>
                </div>
                <div class="panel-body">
                    <div id="tabla-resultados-requisitos-oferta"></div>
                </div>
            </div>
        </div>        
        ...
        <div class="col-md-5">
            <div class="panel panel-default">
                <div class="panel-heading">
                    <strong>REQUISITOS DISPONIBLES</strong>
                </div>
                <div class="panel-body">                            
                    <div id="tabla-resultados-requisitos-disponibles"></div>
                </div>
            </div>
        </div>
    </div>
