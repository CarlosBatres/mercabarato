<div class="container-fluid">
    ...
    <div class="row">
        ...
        <div class="col-md-2 text-center">
            <div class="row">
                <div class="col-md-12">
                    <div class="alert alert-info">                         
                        <p> Selecciona del listado en la izquierda los clientes que desees incluir en la oferta y presiona <strong>Mover</strong></p>
                    </div>
                </div>
            </div>
            <div class="row">
            ...
            <div class="row">
                <div class="col-md-12">                    
                    <a href="<?php echo site_url('panel_vendedor/ofertas/detalles')?>" class="btn btn-success">Continuar <span class="glyphicon glyphicon-ok"></span></a>
                </div>
            </div>
        </div>
        <div class="col-md-5">
            <div class="panel panel-default">
                <div class="panel-heading">
                    <strong>Clientes a ofrecer la Oferta</strong>
                </div>
                <div class="panel-body">                            
