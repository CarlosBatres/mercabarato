            ...
            <tbody>
                <?php foreach ($clientes as $cliente): ?>
                    <tr>                        
                        ...
                        <td>
                            <div class="options">
                                <a class="action" href="<?php echo site_url('panel_vendedor/invitaciones/aceptar') . '/' . $cliente->invitacion_id ?>" data-toogle="tooltip"  title="Aceptar"><i class="glyphicon glyphicon-ok"></i></a>                                
                                <a class="action" href="<?php echo site_url('panel_vendedor/invitaciones/rechazar') . '/' . $cliente->invitacion_id ?>" data-toogle="tooltip"  title="Rechazar"><i class="glyphicon glyphicon-remove"></i></a>                                
                            </div>                           
                        </td>
                    </tr>
                <?php endforeach; ?>
