                            ...
                            <?php if ($titulo != "" && $comentario != ""): ?>
                                ...
                                <tr>
                                    <td style="padding: 0 0 15px 0; color: #153643; font-family: Arial, sans-serif; font-size: 16px; line-height: 20px;">
                                        ...
                                        <a href="<?php echo site_url("panel_vendedor/invitaciones/recibidas"); ?>">Link para continuar...</a>
                                    </td>
                                </tr>
                            <?php else: ?>
                                <tr>
                                ...
                                <tr>
                                    <td style="padding: 20px 0 30px 0; color: #153643; font-family: Arial, sans-serif; font-size: 16px; line-height: 20px;">
                                        Tienes una nueva invitacion pendiente desde nuestro sitio , si deseas interactuar con este Cliente sigue las instrucciones a continuacion.
                                    </td>
                                </tr>
                                <tr>
                                    <td style="padding: 0 0 15px 0; color: #153643; font-family: Arial, sans-serif; font-size: 16px; line-height: 20px;">
