                ...
                <tr>
                    <td bgcolor="#ffffff" style="padding: 40px 30px 40px 30px;">
                        <table border="0" cellpadding="0" cellspacing="0" width="100%">                                
                            ...
                            <tr>
                                <td style="padding: 20px 0 30px 0; color: #153643; font-family: Arial, sans-serif; font-size: 16px; line-height: 20px;">
                                    Tienes una nueva invitación de <strong><?php echo $identidad ?></strong> en nuestro sitio , si deseas interactuar con el y ofrecerle tarifas y ofertas sigue las instrucciones a continuación.
                                </td>
                            </tr>
                            <?php if ($registrar): ?>
                                <tr>
                                    <td style="padding: 0 0 15px 0; color: #153643; font-family: Arial, sans-serif; font-size: 16px; line-height: 20px;">
                                        <p>Puedes ingresar al sitio y proceder a <a href="<?php echo site_url("registro"); ?>"><strong>registrarse</strong></a>.</p>                                        
                                    </td>
                                </tr>                                
                            <?php else: ?>
                                <tr>
