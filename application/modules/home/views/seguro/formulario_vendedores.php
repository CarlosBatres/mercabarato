                ...
                <div class="col-md-12">
                    <div class="panel panel-default">
                        <div class="panel-body">                                                                        
                            <?php echo form_open('seguros/enviar-directo', 'id="seguro_hogar"'); ?>                 
        ...
        <div class="tab-pane" id="riesgo">
            <div class="row">        
                <div class="col-md-12">
                    <div class="panel panel-default">
                        <div class="panel-body">                                                                        
                            <?php echo form_open('seguros/enviar-directo', 'id="seguro_riesgo"'); ?>                 
        ...
        <div class="tab-pane" id="salud">                    
            <div class="row">        
                <div class="col-md-12">
                    <div class="panel panel-default">
                        <div class="panel-body">                                                                        
                            <?php echo form_open('seguros/enviar-directo', 'id="seguro_salud"'); ?>                 
        ...
        <div class="tab-pane" id="otros">
            <div class="row">        
                <div class="col-md-12">
                    <div class="panel panel-default">
                        <div class="panel-body">                                                                        
                            <?php echo form_open('seguros/enviar-directo', 'id="seguro_otros"'); ?>                 
