...
<div id="content">
    <div class="container">
        <br><br>
        <p>En cumplimiento con el deber de información recogido en artículo 10 de la Ley 34/2002, de 11 de julio, de Servicios de la Sociedad de la Información y del Comercio Electrónico a continuación se declara www.mercabarato.com como un sitio web personal gestionado por [nombre titular] con DNI [número] (en adelante, "el prestador") con domicilio en [domicilio].</p>
        ...
        <p>Por tanto, el prestador garantiza al usuario a que bajo ningún concepto los datos personales recogidos en el sitio web serán cedidos, compartidos, transferidos, ni vendidos a ningún tercero.</p>
        <p>Por las mismas razones, el proceso de registro no debe ser utilizado para inscribir direcciones de correo de personas ajenas sin el consentimiento expreso de las personas afectadas. www.mercabarato.com implementa como contramedida a esta prácticas una lista de correo de tipo double opt-in que necesita la confirmación explicita por parte del titular de la cuenta de correo electrónico indicada como dirección de suscripción, antes de recibir comunicaciones por correo electrónico.</p>
        ...
        <p>Google Analytics es un servicio análisis de datos estadísticas prestado por la empresa Google (política de privacidad). www.mercabarato.com utiliza este servicio para realizar un seguimiento de las estadísticas de uso del mismo.<p>
        ...
        <p>Google usará esta información por cuenta nuestra con el propósito de generar información estadísticas sobre el uso de www.mercabarato.com, Google no asociará su dirección IP con ningún otro dato del que disponga Google. Google podrá transmitir dicha información a terceros cuando así se lo requiera la legislación, o cuando dichos terceros procesen la información por cuenta de Google.</p>
        <p>Puede Usted rechazar el tratamiento de los datos o la información rechazando el uso de cookies mediante la selección de la configuración apropiada de su navegador, sin embargo, de hacerlo, limitará la plena funcionabilidad de www.mercabarato.com. Al utilizar este sitio web, da su consentimiento al tratamiento de información por Google en la forma y para los fines arriba indicados.</p>
        <h2>Consentimiento al tratamiento de los datos personales del usuario</h2>
        <p>En el marco de sus actividades, www.mercabarato.com dispone de la posibilidad de registro de usuarios para el envío de comunicaciones por correo electrónico, efectuar comentarios en el sitio y enviar mensajes a través del formulario de contacto.</p>
        <p>El usuario mediante los actos de suscripción al sitio, la realización comentarios o el formulario de contacto estará dando su consentimiento expreso al tratamiento de los personales proporcionados según lo dispuesto en el artículo 6 de la LOPD. El usuario podrá ejercer sus derechos en los términos dispuestos por el artículo 5 de la LOPD.</p>
        ...
        <p>Los datos de carácter personal solicitados en estas actividades, quedarán incorporados a un fichero cuya finalidad es la comunicación de novedades relativas al sitio web de www.mercabarato.com actuando como responsable del fichero el prestador. Los campos marcados con asterisco son de cumplimentación obligatoria, siendo imposible realizar la finalidad expresada si no se aportan estos datos. Queda igualmente informado de la posibilidad de ejercitar los derechos que se indican en el apartado relativo a los Derechos del usuario.</p>
        <h2>Derechos del usuario</h2>
        <p>De conformidad con lo establecido en el artículo 5 de la LOPD, se informa al usuario que la finalidad exclusiva de la base de datos de registro es el envío de información sobre novedades relacionadas con el sitio web www.mercabarato.com. Únicamente los titulares tendrán acceso a sus datos, y bajo ningún concepto, estos datos serán cedidos, compartidos, transferidos, ni vendidos a ningún tercero.</p>
        <p>De acuerdo con lo dispuesto en la LOPD, el usuario en cualquier momento podrá ejercitar sus derechos de acceso, rectificación, cancelación, y oposición ante el prestador.</p>
        <p>Para facilitar el ejercicio de estos derechos se facilita en todas las comunicaciones un enlace de solicitud de baja que redundará en la eliminación inmediata de los datos personales del usuario de nuestra base de datos.</p>        
        <h2>Propiedad Intelectual y uso de los contenidos</h2>
        <p>El sitio web www.mercabarato.com, incluyendo a título enunciativo pero no limitativo su programación, edición, compilación y demás elementos necesarios para su funcionamiento, los diseños, logotipos, texto y/o gráficos son propiedad del prestador o en su caso dispone de licencia o autorización expresa por parte de los autores.</p>
        <p>www.mercabarato.com otorga al usuario una licencia Creative Commons Reconocimiento-NoComercial-CompartirIgual 3.0 cuyos términos exactos se pueden consultar en este enlace. </p>
