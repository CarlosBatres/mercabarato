$(document).ready(function() {
    localStorage.setItem("anuncios_enviar_listado_checkboxes", "");
    updateResultados();
    ...
    $('#enviar_terminar').on('click', function(e) {
        e.preventDefault();
        ...
        $.ajax({
            ...
            data: {
                ...
                cliente_ids:localStorage.getItem('anuncios_enviar_listado_checkboxes')
            },
            dataType: "json",
...
function bind_checkbox() {
    $('#tabla-resultados').find("input[name='seleccionar']").on('change', function() {
        ...
        var chk = localStorage.getItem('anuncios_enviar_listado_checkboxes').split(";;");
        if (chk[0] === "") {
            chk = [];
        }
        var tmp;
        ...
        tmp = chk.join(";;");
        localStorage.setItem('anuncios_enviar_listado_checkboxes', tmp);
    });
