$(document).ready(function() {        
    ...
    $("#detalles_oferta").validate({        
        ...
        messages: {                        
            ...
            fecha_finaliza: {required:"Indica una fecha de finalizacion de la oferta",date:"Ingresa una fecha valida",greaterThan:"La fecha de finalizar debe ser mayor que la de inicio"},
